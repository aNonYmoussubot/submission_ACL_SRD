...
def preprocess_opts(parser):
    parser.add_argument('-data_dir', required=False, help='The source file of the data')
    parser.add_argument('-save_data_dir', required=False, help='The saving path for the data')
...
def predict_opts(parser):
    parser.add_argument('-src_file', required=False, help="""Path to source file""")
...
def post_predict_opts(parser):
    parser.add_argument('-pred_file_path', type=str, required=False,
                        help="Path of the prediction file.")
    parser.add_argument('-src_file_path', type=str, required=False,
    ...
    parser.add_argument('-all_ks', nargs='+', default=['3','5', '10', 'M'], type=str,
                        help='only allow integer or M')
    parser.add_argument('-present_ks', nargs='+', default=['3','5', '10', 'M'], type=str,
                        help='')
    parser.add_argument('-absent_ks', nargs='+', default=['3','5', '10', '50', 'M'], type=str,
                        help='')
